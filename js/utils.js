...
/* ---- 彩蛋关解锁门槛 ----
 * 用「累计星数」而不是「某一关拿到 N 星」：
 *   - 旧条件把门槛绑死在单关（第 3 关 2 星），一旦卡在那关就永远解锁不了；
 *   - 累计制可以分多次推进，任意关的表现都能算数；
 *   - 配合各级「1 星门槛低于最低通关分」的设计（通关必得 ≥1 星），
 *     玩家通关 6 关即可自然解锁，不需要刻意刷分。 */
const EGG_UNLOCK_STARS = 6;
